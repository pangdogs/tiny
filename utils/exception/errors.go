...
import (
	...
	core_exception "git.golaxy.org/core/utils/exception"
)

var (
	ErrTiny     = fmt.Errorf("%w: tiny", core_exception.ErrCore) // 内核错误
	ErrPanicked = core_exception.ErrPanicked                     // panic错误
	ErrArgs     = core_exception.ErrArgs                         // 参数错误
)
